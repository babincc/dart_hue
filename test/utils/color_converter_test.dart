...
void main() {
  group(
    ...
    () {
      ...
      test(
        'color',
        () {
          final RgbColor expectedColor1 = const RgbColor(
            0.0 * 255,
            0.24954145368056627 * 255,
            1.0 * 255,
          );
          final RgbColor actualColor1 =
              ColorConverter.xy2color(xy1[0], xy1[1]).toRgbColor();
          expect(actualColor1.r, expectedColor1.r);
          expect(actualColor1.g, expectedColor1.g);
          expect(actualColor1.b, expectedColor1.b);

          final RgbColor expectedColor2 = const RgbColor(
            1.0 * 255,
            0.8702763507890375 * 255,
            0.0 * 255,
          );
          final RgbColor actualColor2 =
              ColorConverter.xy2color(xy2[0], xy2[1]).toRgbColor();
          ...
          final RgbColor expectedColor6 = const RgbColor(
            0.46264977976038774 * 255,
            1.0 * 255,
            0.5161695277671207 * 255,
          );
          final RgbColor actualColor6 =
              ColorConverter.xy2color(xy6[0], xy6[1]).toRgbColor();
    ...
    () {
      ...
      test(
        ...
        () {
          ...
          final RgbColor expectedColor7 = const RgbColor(
            0.5411764705882353 * 255,
            0.2823529411764706 * 255,
            0.5325490196078431 * 255,
          );
          final RgbColor actualColor7 =
  ...
  group(
    ...
    () {
      ...
      Color color2 = Color.hex('00ff00');
      Color color3 = Color.hex('0000ff');
      Color color4 = Color.hex('808080');
      Color color5 = Color.hex('000000');
      Color color6 = Color.hex('ffffff');
      Color color7 = Color.hex('8a4888');
