...
import 'package:dart_hue/domain/models/light/light.dart';
import 'package:dart_hue/domain/models/light/light_alert.dart';
import 'package:dart_hue/domain/models/light/light_archetype.dart';
import 'package:dart_hue/domain/models/light/light_color/light_color.dart';
import 'package:dart_hue/domain/models/light/light_color/light_color_gamut.dart';
import 'package:dart_hue/domain/models/light/light_color/light_color_gamut_type.dart';
import 'package:dart_hue/domain/models/light/light_color/light_color_xy.dart';
import 'package:dart_hue/domain/models/light/light_color_temperature/light_color_temperature.dart';
import 'package:dart_hue/domain/models/light/light_color_temperature/light_color_temperature_delta.dart';
import 'package:dart_hue/domain/models/light/light_color_temperature/light_color_temperature_delta_action.dart';
import 'package:dart_hue/domain/models/light/light_color_temperature/light_color_temperature_mirek_schema.dart';
import 'package:dart_hue/domain/models/light/light_dimming/light_dimming_delta.dart';
import 'package:dart_hue/domain/models/light/light_dimming/light_dimming_delta_action.dart';
import 'package:dart_hue/domain/models/light/light_dimming/light_dimming_full.dart';
import 'package:dart_hue/domain/models/light/light_dynamics.dart';
import 'package:dart_hue/domain/models/light/light_effects.dart';
import 'package:dart_hue/domain/models/light/light_gradient/light_gradient_full.dart';
import 'package:dart_hue/domain/models/light/light_metadata.dart';
import 'package:dart_hue/domain/models/light/light_mode.dart';
import 'package:dart_hue/domain/models/light/light_on.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_color/light_power_up_color.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_color/light_power_up_color_color_temperature.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_color/light_power_up_color_mode.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_dimming/light_power_up_dimming.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_dimming/light_power_up_dimming_mode.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_on/light_power_up_on.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_on/light_power_up_on_mode.dart';
import 'package:dart_hue/domain/models/light/light_power_up/light_power_up_preset.dart';
import 'package:dart_hue/domain/models/light/light_signaling/light_signaling.dart';
import 'package:dart_hue/domain/models/light/light_signaling/light_signaling_status.dart';
import 'package:dart_hue/domain/models/light/light_timed_effects.dart';
import 'package:dart_hue/domain/models/relative.dart';
import 'package:dart_hue/domain/models/resource_type.dart';
import 'package:dart_hue/exceptions/gradient_exception.dart';
import 'package:dart_hue/exceptions/invalid_name_exception.dart';
import 'package:dart_hue/exceptions/invalid_value_exception.dart';
import 'package:dart_hue/exceptions/mirek_exception.dart';
    ...
    ApiFields.signaling: {
      ApiFields.status: {
        ...
        ApiFields.estimatedEnd:
            DateTimeTool.toHueString(DateTimeTool.dateOnly(DateTime.now())),
      },
      ApiFields.signalValues: ['no_signal', 'on_off']
    },
