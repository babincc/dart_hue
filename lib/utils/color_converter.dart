...
class ColorConverter {
  ...
  /// Converts xy coordinates in the CIE 1931 color space to a Dart Color.
  ...
  /// Converts HSV values to a Dart Color object.
  ...
  /// Converts a hex string to a Dart Color object.
  ...
  /// Converts HSL values to a Dart Color object.
  ...
  /// Converts a Dart Color object to xy coordinates in the CIE 1931 color
  /// space.
  ///
  /// Returns a list of doubles representing the xy values. [x, y, brightness]
  ...
  /// Converts a Dart Color object to a hex string.
  ///
  /// Returns a string representing the hex value. ffffffff
...
extension Converters on Color {
  ...
  /// Converts a Dart Color object to a [ColorXy] object.
  ColorXy toColorXy() {
    final List<double> xy = ColorConverter.color2xy(this);
    return ColorXy(xy[0], xy[1], xy[2]);
  }

  /// Converts a Dart Color object to a [ColorRgb] object.
  ColorRgb toColorRgb() {
